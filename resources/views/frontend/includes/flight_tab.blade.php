       ...
       <div class="col-md-3 col-lg-2 mt15">
           <div class="advance-search-field position-relative text-start">
               <div class="box-search">
                   ...
                   <span id="adult-number-prompt"></span>
               </div>
           </div>
       </div>
       <div class="col-md-3 col-lg-2 mt15">
       ...
       <div class="col-md-3 col-lg-3 mt15">
           <div class="advance-search-field position-relative text-start">
               <div class="box-search">
                   ...
                   {!! Form::select('travel_type', ['1'=>'one way','0'=>'return'] , null,['class'=>'form-control bgc-f7 bdrs12 capitalize','id'=>'travel_type','placeholder'=>'Select type']) !!}
               </div>
           </div>
       </div>
