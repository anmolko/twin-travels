...
@section('content')
    ...
    <section class="breadcumb-section bgc-f7" style="    padding: 40px 0 0px 0px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcumb-style1">
                        <h2 class="title">{{ count($data['rows']) }} blogs found</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="our-blog bgc-f8" style="padding: 35px 0;">
        <div class="container">
